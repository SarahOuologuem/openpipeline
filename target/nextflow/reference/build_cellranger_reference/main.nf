// build_cellranger_reference integration_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/reference/build_cellranger_reference/config.vsh.yaml",
    "platform" : "nextflow",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/reference_build_cellranger_reference",
