// sync_test_resources integration_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/download/sync_test_resources/"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/download/sync_test_resources/config.vsh.yaml",
    "platform" : "nextflow",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/download_sync_test_resources",
