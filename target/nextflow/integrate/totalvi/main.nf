    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/integrate/totalvi/"
      },
      {
        "type" : "file",
...
def main():
    ...
    mdata_query.mod[par["query_modality"]].obsm[par["obsm_output"]] = vae_query.get_latent_representation()
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/integrate_totalvi",
