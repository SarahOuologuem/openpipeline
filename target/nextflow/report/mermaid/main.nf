...
thisConfig = processConfig(jsonSlurper.parseText('''{
  "functionality" : {
    ...
    "arguments" : [
      ...
      },
      {
        "type" : "string",
        "name" : "--output_format",
        "description" : "Output format for the generated image. By default will be inferred from the extension \nof the file specified with --output.\n",
        "required" : false,
        "choices" : [
          "svg",
          "png",
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/report/mermaid/"
      },
      {
        "type" : "file",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/report/mermaid/config.vsh.yaml",
    "platform" : "nextflow",
...
$( if [ ! -z ${VIASH_PAR_WIDTH+x} ]; then echo "${VIASH_PAR_WIDTH}" | sed "s#'#'\\"'\\"'#g;s#.*#par_width='&'#" ; else echo "# par_width="; fi )
$( if [ ! -z ${VIASH_PAR_HEIGHT+x} ]; then echo "${VIASH_PAR_HEIGHT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_height='&'#" ; else echo "# par_height="; fi )
$( if [ ! -z ${VIASH_PAR_BACKGROUND_COLOR+x} ]; then echo "${VIASH_PAR_BACKGROUND_COLOR}" | sed "s#'#'\\"'\\"'#g;s#.*#par_background_color='&'#" ; else echo "# par_background_color="; fi )
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/report_mermaid",
