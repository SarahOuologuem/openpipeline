...
par = {
  ...
  'number_of_observations': $( if [ ! -z ${VIASH_PAR_NUMBER_OF_OBSERVATIONS+x} ]; then echo "int(r'${VIASH_PAR_NUMBER_OF_OBSERVATIONS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/filter_subset_h5mu",
