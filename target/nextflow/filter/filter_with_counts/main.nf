// filter_with_counts integration_build
// 
...
par = {
  ...
  'min_fraction_mito': $( if [ ! -z ${VIASH_PAR_MIN_FRACTION_MITO+x} ]; then echo "float(r'${VIASH_PAR_MIN_FRACTION_MITO//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'max_fraction_mito': $( if [ ! -z ${VIASH_PAR_MAX_FRACTION_MITO+x} ]; then echo "float(r'${VIASH_PAR_MAX_FRACTION_MITO//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/filter_filter_with_counts",
