// cellbender_remove_background_v0_2 integration_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/correction/cellbender_remove_background_v0_2/"
      },
      {
        "type" : "file",
        "path" : "helper.py",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/correction/cellbender_remove_background_v0_2/config.vsh.yaml",
    "platform" : "nextflow",
