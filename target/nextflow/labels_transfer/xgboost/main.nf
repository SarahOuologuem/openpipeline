...
thisConfig = processConfig(jsonSlurper.parseText('''{
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/labels_transfer/xgboost/config.vsh.yaml",
    "platform" : "nextflow",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/labels_transfer_xgboost",
