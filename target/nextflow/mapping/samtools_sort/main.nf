// samtools_sort integration_build
// 
...
thisConfig = processConfig(jsonSlurper.parseText('''{
  ...
  "info" : {
    ...
    "git_remote" : "https://github.com/SarahOuologuem/openpipeline"
  }
}'''))
...
par = {
  ...
  'output_bam': $( if [ ! -z ${VIASH_PAR_OUTPUT_BAM+x} ]; then echo "r'${VIASH_PAR_OUTPUT_BAM//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_bai': $( if [ ! -z ${VIASH_PAR_OUTPUT_BAI+x} ]; then echo "r'${VIASH_PAR_OUTPUT_BAI//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_format': $( if [ ! -z ${VIASH_PAR_OUTPUT_FORMAT+x} ]; then echo "r'${VIASH_PAR_OUTPUT_FORMAT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'compression': $( if [ ! -z ${VIASH_PAR_COMPRESSION+x} ]; then echo "int(r'${VIASH_PAR_COMPRESSION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'minimizer_cluster': $( if [ ! -z ${VIASH_PAR_MINIMIZER_CLUSTER+x} ]; then echo "r'${VIASH_PAR_MINIMIZER_CLUSTER//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'minimizer_kmer': $( if [ ! -z ${VIASH_PAR_MINIMIZER_KMER+x} ]; then echo "int(r'${VIASH_PAR_MINIMIZER_KMER//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'sort_by_read_names': $( if [ ! -z ${VIASH_PAR_SORT_BY_READ_NAMES+x} ]; then echo "r'${VIASH_PAR_SORT_BY_READ_NAMES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'sort_by': $( if [ ! -z ${VIASH_PAR_SORT_BY+x} ]; then echo "r'${VIASH_PAR_SORT_BY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'no_pg': $( if [ ! -z ${VIASH_PAR_NO_PG+x} ]; then echo "r'${VIASH_PAR_NO_PG//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
