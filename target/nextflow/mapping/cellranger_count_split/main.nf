...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/mapping/cellranger_count_split/"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/mapping/cellranger_count_split/config.vsh.yaml",
    "platform" : "nextflow",
...
$( if [ ! -z ${VIASH_PAR_FILTERED_H5+x} ]; then echo "${VIASH_PAR_FILTERED_H5}" | sed "s#'#'\\"'\\"'#g;s#.*#par_filtered_h5='&'#" ; else echo "# par_filtered_h5="; fi )
$( if [ ! -z ${VIASH_PAR_METRICS_SUMMARY+x} ]; then echo "${VIASH_PAR_METRICS_SUMMARY}" | sed "s#'#'\\"'\\"'#g;s#.*#par_metrics_summary='&'#" ; else echo "# par_metrics_summary="; fi )
$( if [ ! -z ${VIASH_PAR_MOLECULE_INFO+x} ]; then echo "${VIASH_PAR_MOLECULE_INFO}" | sed "s#'#'\\"'\\"'#g;s#.*#par_molecule_info='&'#" ; else echo "# par_molecule_info="; fi )
...
$( if [ ! -z ${VIASH_PAR_RAW_H5+x} ]; then echo "${VIASH_PAR_RAW_H5}" | sed "s#'#'\\"'\\"'#g;s#.*#par_raw_h5='&'#" ; else echo "# par_raw_h5="; fi )
