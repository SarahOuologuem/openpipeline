// star_build_reference integration_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/mapping/star_build_reference/"
      }
    ],
...
par = {
  ...
  'transcriptome_gtf': $( if [ ! -z ${VIASH_PAR_TRANSCRIPTOME_GTF+x} ]; then echo "r'${VIASH_PAR_TRANSCRIPTOME_GTF//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'genomeSAindexNbases': $( if [ ! -z ${VIASH_PAR_GENOMESAINDEXNBASES+x} ]; then echo "int(r'${VIASH_PAR_GENOMESAINDEXNBASES//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
