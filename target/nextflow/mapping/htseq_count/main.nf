        ...
        "arguments" : [
          {
            ...
            "description" : "Sorting order of <alignment_file>. Paired-end sequencing data must be sorted either by position or\nby read name, and the sorting order must be specified. Ignored for single-end data.\n",
            "info" : {
              "orig_arg" : "--order"
            },
            "default" : [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/mapping/htseq_count/"
      }
    ],
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/mapping_htseq_count",
