...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/demux/bcl2fastq/"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/demux/bcl2fastq/config.vsh.yaml",
    "platform" : "nextflow",
...
$( if [ ! -z ${VIASH_PAR_IGNORE_MISSING+x} ]; then echo "${VIASH_PAR_IGNORE_MISSING}" | sed "s#'#'\\"'\\"'#g;s#.*#par_ignore_missing='&'#" ; else echo "# par_ignore_missing="; fi )
