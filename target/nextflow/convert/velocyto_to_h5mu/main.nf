// velocyto_to_h5mu integration_build
// 
...
par = {
  'input_loom': $( if [ ! -z ${VIASH_PAR_INPUT_LOOM+x} ]; then echo "r'${VIASH_PAR_INPUT_LOOM//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/convert_velocyto_to_h5mu",
