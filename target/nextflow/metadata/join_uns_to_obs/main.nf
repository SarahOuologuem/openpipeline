// join_uns_to_obs integration_build
// 
...
par = {
  ...
  'uns_key': $( if [ ! -z ${VIASH_PAR_UNS_KEY+x} ]; then echo "r'${VIASH_PAR_UNS_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/metadata_join_uns_to_obs",
