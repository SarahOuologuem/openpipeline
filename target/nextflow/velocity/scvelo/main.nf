    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/velocity/scvelo/"
      },
      {
        "type" : "file",
...
par = {
  ...
  'min_cells_u': $( if [ ! -z ${VIASH_PAR_MIN_CELLS_U+x} ]; then echo "int(r'${VIASH_PAR_MIN_CELLS_U//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_shared_counts': $( if [ ! -z ${VIASH_PAR_MIN_SHARED_COUNTS+x} ]; then echo "int(r'${VIASH_PAR_MIN_SHARED_COUNTS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_shared_cells': $( if [ ! -z ${VIASH_PAR_MIN_SHARED_CELLS+x} ]; then echo "int(r'${VIASH_PAR_MIN_SHARED_CELLS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'n_top_genes': $( if [ ! -z ${VIASH_PAR_N_TOP_GENES+x} ]; then echo "int(r'${VIASH_PAR_N_TOP_GENES//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'log_transform': $( if [ ! -z ${VIASH_PAR_LOG_TRANSFORM+x} ]; then echo "r'${VIASH_PAR_LOG_TRANSFORM//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'n_principal_components': $( if [ ! -z ${VIASH_PAR_N_PRINCIPAL_COMPONENTS+x} ]; then echo "int(r'${VIASH_PAR_N_PRINCIPAL_COMPONENTS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/velocity_scvelo",
