...
$( if [ ! -z ${VIASH_PAR_TRANSCRIPTOME+x} ]; then echo "${VIASH_PAR_TRANSCRIPTOME}" | sed "s#'#'\\"'\\"'#g;s#.*#par_transcriptome='&'#" ; else echo "# par_transcriptome="; fi )
$( if [ ! -z ${VIASH_PAR_BARCODE+x} ]; then echo "${VIASH_PAR_BARCODE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_barcode='&'#" ; else echo "# par_barcode="; fi )
$( if [ ! -z ${VIASH_PAR_WITHOUT_UMI+x} ]; then echo "${VIASH_PAR_WITHOUT_UMI}" | sed "s#'#'\\"'\\"'#g;s#.*#par_without_umi='&'#" ; else echo "# par_without_umi="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "${VIASH_PAR_OUTPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output='&'#" ; else echo "# par_output="; fi )
$( if [ ! -z ${VIASH_PAR_LOGIC+x} ]; then echo "${VIASH_PAR_LOGIC}" | sed "s#'#'\\"'\\"'#g;s#.*#par_logic='&'#" ; else echo "# par_logic="; fi )
